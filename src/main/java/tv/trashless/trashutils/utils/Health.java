...
public class Health {
    ...
    public static void set(Collection<? extends Player> players, double newHealth) {
        for (Player player : players) player.setHealth(Math.min(newHealth, Health.get(player)));
    }
    ...
    public static void setMax(Collection<? extends Player> players, double newMaxHealth) {
